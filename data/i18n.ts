...
export const i18n = {
  nav: {
    ...
    publications: { zh: "论文", en: "Publications", zhHant: "論文" },
  ...
  actions: {
    ...
    expand: { zh: "查看详情", en: "View details", zhHant: "查看詳情" },
  ...
  sections: {
    ...
    publications: {
      eyebrow: { zh: "Publications", en: "Publications", zhHant: "Publications" },
      title: { zh: "论文与投稿", en: "Publications and submissions", zhHant: "論文與投稿" }
    },
    experience: {
  ...
  labels: {
    ...
    metrics: { zh: "指标", en: "Metrics", zhHant: "指標" },
    keywords: { zh: "关键词", en: "Keywords", zhHant: "關鍵詞" },
    awards: { zh: "奖项", en: "Awards", zhHant: "獎項" },
    sourceNote: {
